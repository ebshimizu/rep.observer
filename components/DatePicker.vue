...
// if there's any particular reason why nuxt/ui decided to make this a custom component we just have to copy
// instead of a component we have to define ourselves...
